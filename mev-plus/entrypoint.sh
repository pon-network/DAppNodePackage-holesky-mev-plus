...
if [ -n "$_DAPPNODE_GLOBAL_MEVBOOST_HOLESKY" ] && [ "$_DAPPNODE_GLOBAL_MEVBOOST_HOLESKY" == "false" ]; then
    EXTRA_OPTS="${EXTRA_OPTS} -externalValidatorProxy.address http://mev-boost-holesky.mev-boost.dappnode:18550"
fi
